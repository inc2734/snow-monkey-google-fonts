...
namespace Snow_Monkey\Plugin\GoogleFonts\App;
...
class Updater {
	...
	public function __construct() {
		...
		add_filter( 'inc2734_github_plugin_updater_zip_url_inc2734/snow-monkey-google-fonts', array( $this, '_zip_url' ) );
		add_filter( 'inc2734_github_plugin_updater_request_url_inc2734/snow-monkey-google-fonts', array( $this, '_request_url' ), 10, 4 );
	}
	...
	public function _init() {
		new Bootstrap(
			plugin_basename( SNOW_MONKEY_GOOGLE_FONTS_PATH . '/snow-monkey-google-fonts.php' ),
			'inc2734',
	...
	public function _request_url( $url, $user_name, $repository, $version ) {
		return ! $version
			? 'https://snow-monkey.2inc.org/github-api/snow-monkey-google-fonts/response.json'
			: sprintf(
				'https://snow-monkey.2inc.org/github-api/snow-monkey-google-fonts/packages/%1$s/response.json',
				$version
			);
	}
}
